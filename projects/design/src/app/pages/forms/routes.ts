...
export const routesForms: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        title: TITLE_DEFINITION.FORMS.INPUT_AUTOCOMPLETE,
        loadComponent: () =>
      ...
      },
      {
        ...
        title: TITLE_DEFINITION.FORMS.INPUT_NUMBER,
        loadComponent: () =>
